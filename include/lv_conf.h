...
#define LV_ASSERT_HANDLER_INCLUDE <switch.h>
#define LV_ASSERT_HANDLER diagAbortWithResult(MAKERESULT(Module_Libnx, LibnxError_ShouldNotHappen));

#else

#define LV_ASSERT_HANDLER_INCLUDE <stdlib.h>
#define LV_ASSERT_HANDLER exit(1);
